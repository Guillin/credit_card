...
def preprocess_text(text, stop_words=[], root_method=None):
    ...
    assert root_method in ['lemmatization', 'stemming', None], f"'kind' should be 'lemmatization' or 'stemming'. {process} was provided"
    ...
    for w in doc:
        ...
        if w.text != '\n' and not w.is_stop and not w.is_punct and not w.like_num:
            ...
            if root_method=='lemmatization':
                # we add the lematized version of the word
                word_list.append(w.lemma_)
            elif root_method=='stemming':
